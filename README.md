...
Портфолио в [Yandex DataLens](https://datalens.yandex/fe071bz8rmjg0?tab=pLM).
...
| тестовое задание |[Анализ базы данных операционных продаж](https://github.com/Ravil-1989/portfolio/tree/main/analysis_operational_sales)|В результате исследовательского анализа данных подготовлены рекомендации отделу операционных продаж.|SQL, python, pandas, numpy, sqlite3, matplotlib, plotly, IPython|
| тестовое задание |[Анализ работы службы поддержки](https://github.com/Ravil-1989/portfolio/tree/main/customer_service_analysis)|В результате исследовательского анализа данных подготовлены рекомендации службе поддержки.|python, pandas, numpy, matplotlib|
